...
OBJS	= shim.o mok.o netboot.o cert.o replacements.o tpm.o version.o errlog.o loader.o
KEYS	= shim_cert.h ocsp.* ca.* shim.crt shim.csr shim.p12 shim.pem shim.key shim.cer
ORIG_SOURCES	= shim.c mok.c netboot.c replacements.c tpm.c errlog.c loader.c shim.h version.h $(wildcard include/*.h)
